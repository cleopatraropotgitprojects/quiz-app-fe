    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-yellow-100 via-pink-100 to-blue-100 px-6 py-10">
            ...
            <p className="text-lg text-gray-700 mb-10 text-center max-w-2xl">
                What kind of quiz are you in the mood for today? Pick a category and let the magic begin ✨
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 w-full max-w-5xl">
                ...
                >
                    ...
                    <p className="text-sm text-gray-500">Challenge your brain with smart questions!</p>
                </div>
                ...
                >
                    <div className="text-5xl mb-3">🎭</div>
                    <h3 className="text-xl font-bold text-pink-600 mb-2">Entertainment</h3>
                    <p className="text-sm text-gray-500">Get quirky and discover your character!</p>
                </div>
                ...
                >
                    <div className="text-5xl mb-3">🧠</div>
                    <h3 className="text-xl font-bold text-green-600 mb-2">Psychological</h3>
                    <p className="text-sm text-gray-500">Learn something new about yourself.</p>
                </div>
            </div>
        </div>
    );
